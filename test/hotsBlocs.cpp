...
TEST_CASE("Compute Hots from the given events", "[Hots]") {
  ...
  auto iiwkLayer = tarsier::make_iiwkClustering<NCENTERS,TSSIZE,TsEvent,TsEvent>
    (2e-4, 2e-4,1,battacharya,tsEventFromTsEventIiwk,handlerHots);
  auto standardLayer = tarsier::make_standardClustering<NCENTERS,TSSIZE,TsEvent,TsEvent>
