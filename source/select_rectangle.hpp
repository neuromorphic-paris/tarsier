...
namespace tarsier {
    ...
    /// select_rectangle propagates only the events within the specified rectangular window.
    ...
    make_select_rectangle(uint16_t left, uint16_t bottom, uint16_t width, uint16_t height, HandleEvent handle_event) {
